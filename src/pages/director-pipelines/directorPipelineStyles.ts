...
export const pipelineSuccessButtonClass =
  'inline-flex min-h-10 cursor-pointer items-center justify-center rounded-lg border border-sea-700/70 bg-sea-600/12 px-4 py-2 text-sm font-semibold text-sea-700 shadow-sm transition-colors hover:bg-sea-600/22 focus:outline-none focus-visible:ring-2 focus-visible:ring-sea-500/40 disabled:opacity-60 dark:border-sea-500/50 dark:bg-sea-500/12 dark:text-sea-300'
