...
export const topBarHeaderClass =
  'sticky top-0 z-30 border-b border-fume-800/80 bg-fume-900 shadow-[0_6px_20px_-10px_var(--shadow-elevated-header)]'
...
export const topBarSignedInPrefixClass = 'text-text-muted'
