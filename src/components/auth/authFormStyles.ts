...
export const authPageRootClass =
  'flex min-h-dvh items-center justify-center bg-bg-canvas px-4 font-sans text-text-primary dark:bg-bg-emphasis dark:text-text-inverse'
...
export const authLeadClass = 'mt-1 text-sm text-text-muted dark:text-text-subtle'

export const authFormClass = 'mt-6 space-y-4'

export const authLabelClass = 'block text-xs font-medium text-text-muted dark:text-text-subtle'
...
export const authFooterClass = 'mt-4 text-center text-sm text-text-muted dark:text-text-subtle'
